function [ VertsOut_xyz, WM ] = laplaceDeformGeometricFixed( ConnectivityList, VertsT0_xyz, VertsFixedT1_xyz, fixedInd )
...
% clean out fixed vertex constraint!
VertsFixedT1_xyz(:,fixedInd) = nan(3,1);
...
% append fixed vertex
VFixed = VertsT0_xyz(:,fixedInd);
VFixedConstRow = zeros(1, numVerts);
VFixedConstRow(1, fixedInd) = 1;
